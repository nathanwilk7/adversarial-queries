...
SELECT count(*)
FROM (((((movie_companies CROSS JOIN (title CROSS JOIN complete_cast)) CROSS JOIN info_type) CROSS JOIN movie_info) CROSS JOIN person_info) CROSS JOIN name) CROSS JOIN aka_name
