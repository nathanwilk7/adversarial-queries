SELECT count(*)
FROM aka_name, cast_info, company_name, info_type, keyword, kind_type, link_type, movie_companies, movie_info, movie_keyword, movie_link, name, person_info, role_type, title
