...
SELECT count(*)
FROM ((((((movie_companies CROSS JOIN (title CROSS JOIN person_info)) CROSS JOIN movie_link) CROSS JOIN company_name) CROSS JOIN movie_info) CROSS JOIN movie_keyword) CROSS JOIN info_type) CROSS JOIN keyword
WHERE keyword.phonetic_code = 'Z62'
